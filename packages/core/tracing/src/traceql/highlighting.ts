...
export const getErrorMarkers = (severity: number, model: Monaco.editor.ITextModel, errorNodes: SyntaxNode[]) => {
...
export const getWarningMarkers = (severity: number, model: Monaco.editor.ITextModel) => {
  const markers = []
